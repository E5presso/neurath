...
[installation guide](installation.md) for configuration examples and commands.

The 31 skills operate according to the target repository and current user request. Choose a skill
